...
app = FastAPI(
    title="Pitch Service",
    description="Pitch window management and assignment workflow for Elastic Newsroom Infrastructure",
    version="1.0.0",
...
async def health_check():
    ...
    return {"status": "healthy", "service": "pitch"}


@app.get("/ready")
async def readiness_check():
    """Readiness check endpoint."""
    return {"status": "ready", "service": "pitch"}
