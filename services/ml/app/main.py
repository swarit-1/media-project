...
app = FastAPI(
    title="ML Intelligence Service",
    description="Portfolio ingestion, style matching, duplicate detection, and trust scoring for Elastic Newsroom Infrastructure",
    version="1.0.0",
...
async def readiness_check():
    ...
    return {"status": "ready", "service": "ml"}
